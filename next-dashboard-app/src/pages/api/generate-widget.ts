...
// PATCH: helper to always return chat + widget bundled
function makeChatAndWidget(reply: string, widget?: WidgetResponse) {
  if (widget) {
    return [{ id: makeId("chat"), type: "chat", payload: { reply } }, widget];
  }
  return { id: makeId("chat"), type: "chat", payload: { reply } };
}
