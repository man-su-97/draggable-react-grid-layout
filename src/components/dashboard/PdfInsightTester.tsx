...
// 	return (
// 		<div className="p-6 max-w-2xl mx-auto space-y-6 bg-white border rounded-lg shadow-md">
...
// 					className="w-full border border-gray-300 rounded px-3 py-2 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
// 					placeholder="e.g. Extract key financial figures"
// 				/>
// 			</div>
