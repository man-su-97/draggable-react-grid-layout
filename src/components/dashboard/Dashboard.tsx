...
export default function Dashboard() {
	...
	async function runAICommand() {
		...
		try {
			...
			//check this if your widget creation is failing.Specially for Ai could not understand,
			// Array.isarray() returns true if the value is an array and false
	...
	// 				};
	// 			case "weather":
	// 				return { location: "New Delhi", coordinates: "current", ...payload };
